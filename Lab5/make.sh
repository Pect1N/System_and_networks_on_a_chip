...
xmelab  -v93 -work worklib -cdslib ./cds.lib -logfile ./ncelab.log -errormax 15 -nowarn CUVWSP -nowarn MEMODR worklib.test:main -STATUS -NOTIMINGCHECKS -access +RWC -NOSPECIFY -coverage all

xmsim  -gui -cdslib ./cds.lib -logfile ./ncsim.log -errormax 15 -status worklib.test:main